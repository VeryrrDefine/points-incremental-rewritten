...
var texts = [
    ...
    {
        text: `不会还有人认为340282366920938463463374607431768211456是无限吧`
    },
    {
    ...
    {
        get text() {
            return `${formatPowiainanum(player.points)}点数?弱爆了`
        }
    },
    {
    ...
    {
        get text() {
            return `大数据分析显示，您现在拥有${formatPowiainanum(player.points)}点数`
        }
    },
    {
        text: '我！的！存！在！跨！越！了！时！间！'
    },
    {
        text: '请添加这一条新闻'
    },
